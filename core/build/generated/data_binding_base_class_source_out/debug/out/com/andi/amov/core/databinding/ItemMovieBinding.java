...
package com.andi.amov.core.databinding;
...
public final class ItemMovieBinding implements ViewBinding {
  ...
  private ItemMovieBinding(@NonNull CardView rootView, @NonNull ImageView ivPoster,
      @NonNull RatingBar rBar, @NonNull TextView tvTitle) {
  ...
  public static ItemMovieBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMovieBinding((CardView) rootView, ivPoster, rBar, tvTitle);
    }
